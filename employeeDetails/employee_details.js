...
function findEmployeeBySpecialization(employeeSpecialisation) {
    const foundEmployee = employees.find(employee => employee.specialization === employeeSpecialisation);
    if (foundEmployee) {
